...
/**
 * Class to capture the performance metrics of FairScheduler. This should be a
 * singleton.
 */
...
public class FSOpDurations implements MetricsSource {
	...
	private static final MetricsInfo RECORD_INFO = info("FSOpDurations",
			"Durations of FairScheduler calls or thread-runs");
