 ...
 *
 * A Schedulable is responsible for three roles: 1) Assign resources through
 * {@link #assignContainer}. 2) It provides information about the app/queue to
 * the scheduler, including: - Demand (maximum number of tasks required) -
 * Minimum share (for queues) - Job/queue weight (for fair sharing) - Start time
 * and priority (for FIFO) 3) It can be assigned a fair share, for use with fair
 * scheduling.
 *
...
public interface Schedulable {
	 ...
	 * as number of currently utilized resources + number of unlaunched
	 * resources (that are either not yet launched or need to be speculated).
	 */
